terraform {
  ...
  backend "gcs" {
    ...
    bucket      = "tfstate-prd-211008"                        /* GCS bucket */
    prefix      = "jenkinsfile-prd"                           /* Align with git repo name; this will create jenkinsfile-prd\default.tfstate */
  }
}
...
module "vpc" {
  env_name                = "prd"                             /* The environment for the vpc/cluster */
...
module "tls" {
  source                  = "../../mod/tls"                   /* The path to the module */
}
